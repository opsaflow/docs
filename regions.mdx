...
| **Asia Pacific** | Singapore | `ap` | Yes | Yes | Yes |

<Info>All regions include the same features. Pricing varies by region — EU Central is the cheapest. See [Pricing](/pricing#per-region-pricing) for details.</Info>
