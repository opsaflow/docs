...
<Info>On the **Solo** plan (a single dedicated node), horizontal scaling and failover aren't available. To add nodes and automatic failover, create an [HA cluster](/high-availability).</Info>
