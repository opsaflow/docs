...
|------|---------------------|-------------------|------------------------|
| CPU | 2 vCPU | 2 vCPU (AMD) | 1 vCPU (AMD) |
| RAM | 4 GB | 2 GB | 2 GB |
| Total disk | 40 GB NVMe | 40 GB NVMe | 40 GB NVMe |
| **Available for PostgreSQL** | **30 GB** | **30 GB** | **30 GB** |
| Price | $15/mo | $29/mo | $25/mo |

<Note>EU Central Solo normally runs on Hetzner's Intel **CX** line; during capacity shortages it may be provisioned on an equivalent-or-better AMD **CPX** box (never below the advertised specs). US East and Singapore run on AMD **CPX** instances. Singapore's Solo box is the smallest (1 vCPU / 2 GB / 40 GB).</Note>
